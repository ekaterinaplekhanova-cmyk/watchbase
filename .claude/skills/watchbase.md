...
1. **Не публиковать посты и не вносить изменения на сайт без явного одобрения пользователя.**
2. **Не выдумывать технические характеристики часов.** Если данных не хватает — указать, что нужно уточнить.
